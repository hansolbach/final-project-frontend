...
button.onClick = function() {
    // when button is clicked, switch between co2 and energy
      script.setAttribute("src", "viz2co2.js");
}
...
function ready(error, us, maptemplate) {
  ...
  d3.select(".g-hed").text("Statewide Energy Consumption");

  //Appends chart intro text
  d3.select(".g-intro").text("State energy consumption in 2014, millions of BTUs");
  ...
  map.append("g")
    ...
    .on("mouseover", function(d) {
      ...
      .style("opacity", 1)
      div.text(stateByFIPS[d.id] + ": " + dataByFIPS[d.id] + " million BTUs, 2014")
